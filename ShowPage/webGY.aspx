<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="webGY.aspx.cs" Inherits="ShowPage_webGY" Title="供求信息---公寓信息" %>
                                        ...
                                        <tr>
                                            <td class="huise">
                                                <span class="shenlancu">『<%# DataBinder.Eval(Container.DataItem,"type") %>』</span><span
                                                    class="banhui"><%# DataBinder.Eval(Container.DataItem,"title") %><span>[
                                                        <%# DataBinder.Eval(Container.DataItem,"date") %>
                                                        ]
                                                        <br />
                                                        ...
                                                        联系电话：<%#DataBinder.Eval(Container.DataItem,"tel") %></span></span></td>
                                        </tr>
                                        <tr style="color: #000000">
                                            <td align="center">
                                                <img height="1" src="images/longline.gif" width="525" /></td>
